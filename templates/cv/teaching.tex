...
\begin{alignedentrieshang}[2em]
  \hangingitem{\textbf{Primary Advisor:} ((* for advisee in data.advising | selectattr("degree_year") | rejectattr("degree", "equalto", "B.S.") | selectattr("role", "equalto", "primary") | sort(attribute="lastname") | sort(attribute="degree_year", reverse=True) *))(((advisee.firstname))) (((advisee.lastname))), (((advisee.degree))) (((advisee.degree_year)))((* if not loop.last *)); ((* endif *))((* endfor *)).}{}
  \hangingitem{\textbf{Committee Member:} ((* for advisee in data.advising | selectattr("degree_year") | rejectattr("degree", "equalto", "B.S.") | selectattr("role", "equalto", "committee") | sort(attribute="lastname") | sort(attribute="degree_year", reverse=True) *))(((advisee.firstname))) (((advisee.lastname))), (((advisee.degree))) (((advisee.degree_year)))((* if not loop.last *)); ((* endif *))((* endfor *)).}{}
\end{alignedentrieshang}
